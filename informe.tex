	...
	\section{Análisis de Resultados}
		...
		\subsection{$O(n)$}
			\begin{tikzpicture}
				...
				\end{axis}
			\end{tikzpicture}
			\section[title]{Instrucciones para la ejecución}
		\subsection{$O(n^2)$}
		...
		\subsection{Instrucciones para generar entradas}
		\begin{itemize}
			\item Para generar entradas de la solución cuadrática y lineal, ejecutar el archivo \texttt{./generar.py <valor-n> <valor-m> <valor-k>}
			\item Para generar entradas de la solución $n\log(n)$ ejecutar el archivo \texttt{file.py} dentro de la carpeta \texttt{nlgn}
			\end{itemize}
